...
Hero.regHeroCtor("TianTongKai", _M)
local config = require("src/config/hero/TianTongKaiConfig").Config
Helper.initHeroConfig(config)
--config[5111].hitEvent.cnt = config[5111].hitEvent.cnt + 6
...
function hit_5113(self,bone,evt,originFrameIndex,currentFrameIndex)
	if self.hiting then
...
function rush(self,bone,evt,originFrameIndex,currentFrameIndex)
	...
	local callback = cc.CallFunc:create(function() 
		...
		self.animation:getAnimation():gotoAndPlay(24)
